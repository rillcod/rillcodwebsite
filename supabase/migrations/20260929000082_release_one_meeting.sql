-- Release is always one class meeting. A null session used to activate every
-- held row in the calendar week, which mixed Class 1 material with Class 2.

drop function if exists public.release_prepared_week_atomic(uuid, integer, integer, timestamptz);
