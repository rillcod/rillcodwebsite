...
export default function SchoolRegistrationPage() {
  return (
    <div className={`${PUBLIC_PAGE_ROOT} relative flex min-h-dvh items-center justify-center pl-[max(1rem,var(--safe-area-left))] pr-[max(1rem,var(--safe-area-right))] pt-[max(1rem,var(--safe-area-top))] pb-[max(1rem,var(--safe-area-bottom))] sm:py-12`}>
      {/* Background decor */}
