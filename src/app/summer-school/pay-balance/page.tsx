        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            {isNativeApp
              ...
              : "Installment registrants can complete the remaining balance here (Paystack or bank transfer)."}
          </p>
        </div>
          ...
          {balanceInfo && balanceInfo.balanceDue > 0 && !submitted && (
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-xl p-4 space-y-4">
              ...
              <button
                type="button"
                onClick={payBalance}
                disabled={loading || verifyingReturn || uploadingReceipt || (paymentMethod === "bank_transfer" && !bankTransferReady)}
              ...
              >
                {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : paymentMethod === "bank_transfer" ? <Building2 className="w-4 h-4" /> : <CreditCard className="w-4 h-4" />}
