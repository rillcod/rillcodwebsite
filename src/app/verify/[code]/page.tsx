...
export default function VerifyCodePage() {
  ...
  const [mode, setMode] = useState<'certificate' | null>(null);
            ...
            <div className="text-center py-24 space-y-8 max-w-md mx-auto">
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  No certificate matches the verification code <span className="bg-muted px-2.5 py-1 rounded-md text-foreground font-mono font-bold tracking-tight">{code?.toUpperCase()}</span>.
                </p>
                ...
                <div className="relative flex flex-col md:flex-row items-center gap-6 px-8 py-6 bg-card border border-emerald-500/20 rounded-[1.8rem] shadow-2xl">
                  ...
                  <div className="flex-1 text-center md:text-left space-y-1">
                    <div className="flex items-center justify-center md:justify-start gap-2">
                      <p className="font-black text-emerald-400 text-sm uppercase tracking-[0.2em]">Verified — Authentic Certificate</p>
