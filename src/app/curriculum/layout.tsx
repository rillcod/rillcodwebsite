...
export const metadata: Metadata = {
  title: "Curriculum — STEM & Coding Curriculum for Nigerian Schools | Rillcod Academy",
  description:
    "Explore Rillcod Academy's structured STEM curriculum designed for Nigerian schools. From ICT Fundamentals to advanced Python, Robotics & AI — aligned with Nigerian education standards for JSS1 to SS3.",
  keywords: [
  ...
  openGraph: {
    title: "STEM & Coding Curriculum — Rillcod Academy",
    description:
