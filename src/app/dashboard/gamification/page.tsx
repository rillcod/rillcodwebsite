    ...
    <div className="p-4 sm:p-6 space-y-6 max-w-6xl mx-auto mobile-page-root">
      ...
      {showForm && isAdmin && (
        <div className="mobile-native-dialog fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div role="dialog" aria-modal="true" className="bg-card border border-white/[0.12] rounded-2xl w-full max-w-lg shadow-2xl max-h-[85dvh] overflow-y-auto overscroll-contain">
      ...
      {showAward && (
        <div className="mobile-native-dialog fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div role="dialog" aria-modal="true" className="bg-card border border-white/[0.12] rounded-2xl w-full max-w-md shadow-2xl max-h-[85dvh] overflow-y-auto overscroll-contain">
            <div className="flex items-center justify-between p-5 border-b border-white/[0.08]">
