      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {(() => {
          const statItems = isStaff ? [
            ...
            { label: 'Enrollments', value: courses.reduce((s: number, c: any) => s + (c.enrollments?.length ?? 0), 0), icon: UserGroupIcon, color: 'text-amber-400', bg: 'bg-amber-500/10' },
          ] : [
            ...
            <div key={course.id} className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-white/20 hover:bg-white/8 transition-all flex flex-col">
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="flex items-center gap-3 text-xs text-white/40 mb-4">
                  ...
                  <span className="flex items-center gap-1"><UserGroupIcon className="w-3.5 h-3.5" />{course.enrollments?.length ?? 0} enrolled</span>
                </div>
