        ...
        <div className="relative overflow-hidden border border-border/80 bg-card/90 backdrop-blur-2xl rounded-3xl p-6 sm:p-8 shadow-xl">
          ...
          <div className="relative z-10 flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-black uppercase tracking-tight text-foreground leading-none">Edit Course</h1>
              <p className="text-muted-foreground text-sm mt-1.5 font-medium">Update course details and lesson sequence</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-card shadow-sm border border-border rounded-xl p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select value={form.next_course_id}
                ...
                className="w-full px-4 py-3 bg-card shadow-sm border border-border rounded-xl text-sm text-foreground focus:outline-none focus:border-primary cursor-pointer disabled:opacity-40">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <button type="submit" disabled={saving}
              className="flex items-center gap-2 px-6 py-2.5 bg-primary hover:bg-primary text-foreground text-sm font-bold rounded-xl transition-all disabled:opacity-50 shadow-lg shadow-primary/20">
