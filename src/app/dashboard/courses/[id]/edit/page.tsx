        ...
        <form onSubmit={handleSubmit} className="bg-card shadow-sm border border-border rounded-xl p-6 space-y-5">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <button type="submit" disabled={saving}
              className="flex items-center gap-2 px-6 py-2.5 bg-primary hover:bg-primary text-white text-sm font-bold rounded-xl transition-all disabled:opacity-50 shadow-lg shadow-primary/20">
