...
const MISSIONS: Mission[] = [
  ...
  {
    id: 'm_ai01',
    title: 'Prompt Persona Architect',
    description: 'Structure an AI System Prompt with role framing, rules, and output constraints.',
    instructions: 'Create a system prompt variable that defines an AI STEM tutor persona. Test formatting with a user prompt.',
  ...
  },
  {
    ...
    description: 'Build a Python calculator to size solar panel arrays and battery storage for home microgrids.',
    instructions: 'Write a function solar_size(watts, hours) that calculates required panel array watts (with 25% efficiency margin) and 24V battery Ah capacity.',
    difficulty: 'Intermediate',
    language: 'python',
    xp: 130,
    starterCode: `# ☀️ Solar Array & Battery Capacity Sizing\ndef solar_size(appliance_watts, run_hours):\n    daily_wh = appliance_watts * run_hours\n    required_wh = daily_wh * 1.25 # 25% safety margin\n    array_watts = required_wh / 5.5 # 5.5 peak sun hours\n    battery_ah = (required_wh / 24) * 1.5\n    return array_watts, battery_ah\n\nwatts, battery = solar_size(500, 6)\nprint(f"Required Panel Array: {watts:.0f}W")\nprint(f"Required Battery Bank: {battery:.0f}Ah @ 24V")`,
