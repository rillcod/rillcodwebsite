      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <style jsx global>{`
          @media print {
            ...
            .text-white\\/60, .text-white\\/50, .text-white\\/40, .text-white\\/30 { color: #4b5563 !important; }
            .border-white\\/10, .border-white\\/20, .border-white\\/5 { border-color: #e5e7eb !important; border-width: 1px !important; }
            ...
            .bg-violet-500, .bg-blue-500, .bg-cyan-500, .bg-emerald-500, .bg-amber-500, .bg-rose-500 {
            ...
            .text-violet-400 { color: #1e3a8a !important; }
          }
        `}</style>
      </div>
    </div>
