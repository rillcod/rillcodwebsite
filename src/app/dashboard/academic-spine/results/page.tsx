...
export default function CentralResultsPage() {
  ...
  return <div className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6 lg:p-8">
    <section className="rounded-3xl border border-border bg-card p-6"><Link href="/dashboard/academic-spine" className="text-sm font-bold text-primary">Back to Academic Office</Link><h1 className="mt-3 text-3xl font-black text-foreground">Results workspace</h1><p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">One place for Regular School, Virtual School and Special Programme results. Enrollment keeps each learner in the correct pathway; manual entry remains manual.</p></section>
