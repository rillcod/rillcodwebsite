  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-10">
      ...
      <div className="relative overflow-hidden bg-card border border-border rounded-[2.5rem] p-8 sm:p-14 shadow-2xl">
        ...
        <Link href="/dashboard/progression" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground hover:text-primary mb-8 transition-colors">
