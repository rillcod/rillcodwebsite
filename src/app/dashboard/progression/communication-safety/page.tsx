...
export default function CommunicationSafetyPage() {
  ...
  if (!canView) return <div className="p-20 text-center text-muted-foreground font-bold tracking-widest">Access denied</div>;

  if (!data) return <div className="p-20 text-center text-muted-foreground font-black tracking-widest italic opacity-50">No security data available.</div>;

  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-10 space-y-12 pb-32">
      {/* Security Header */}
      <div className="relative overflow-hidden bg-card border border-border rounded-3xl p-10 sm:p-16 shadow-2xl">
        ...
        <Link href="/dashboard" className="inline-flex items-center gap-2 text-xs font-black tracking-[0.2em] text-muted-foreground hover:text-primary mb-10 transition-colors relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10 relative z-10">
          <div className="space-y-6 max-w-2xl">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-3xl sm:text-4xl font-black tracking-tighter text-card-foreground leading-tight">Safety Centre</h1>
            </div>
            <p className="text-xl text-muted-foreground leading-relaxed italic max-w-xl">
              A clear view of communication concerns, user reports and urgent cases that need human review.
            </p>
          </div>
          <Link 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="group bg-card border border-border rounded-2xl p-10 space-y-6 hover:border-rose-500/20 transition-all duration-500 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex items-center justify-between relative z-10">
             <p className="text-xs font-black tracking-[0.3em] text-muted-foreground">Harmful messages blocked (24h)</p>
          ...
          <p className="text-xs text-muted-foreground leading-relaxed italic">Messages stopped by the safety rules before reaching users.</p>
        </div>
        ...
        <div className="group bg-card border border-border rounded-2xl p-10 space-y-6 hover:border-blue-500/20 transition-all duration-500 shadow-2xl relative overflow-hidden">
          ...
          <p className="text-xs font-black tracking-[0.3em] text-muted-foreground relative z-10">Pending Reports</p>
        ...
        <div className="group bg-card border border-border rounded-2xl p-10 space-y-6 hover:border-orange-500/20 transition-all duration-500 shadow-2xl relative overflow-hidden">
          ...
          <p className="text-xs font-black tracking-[0.3em] text-muted-foreground relative z-10">Urgent cases</p>
      ...
      <div className="bg-card border border-border rounded-[3.5rem] overflow-hidden shadow-2xl">
        <div className="p-10 sm:p-14 border-b border-border bg-muted/10 flex items-center gap-6">
          ...
          <div>
            <h2 className="text-[11px] font-black text-foreground tracking-[0.3em] leading-none">Safety overview</h2>
          ...
          {data.top_abuse_reasons_7d.length === 0 ? (
            <div className="py-20 text-center space-y-4">
              ...
              <div className="space-y-1">
                <p className="text-2xl font-black text-foreground tracking-tighter">No unusual safety pattern detected</p>
                ...
                return (
                  <div key={item.label} className="group/item space-y-4">
                    <div className="flex items-center justify-between px-4">
                      <p className="text-lg font-black text-foreground tracking-tight group-hover/item:text-primary transition-colors">{item.label}</p>
