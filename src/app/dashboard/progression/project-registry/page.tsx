        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-12 relative z-10">
          <div className="space-y-6 max-w-3xl">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-4xl sm:text-6xl font-black tracking-tighter text-card-foreground leading-tight">Activity Library</h1>
            </div>
            <p className="text-xl text-muted-foreground leading-relaxed italic max-w-2xl">
              Manage hands-on project activities used in lessons. These activities are shared across your classes and can be auto-inserted during curriculum generation.
            </p>
          </div>
          {canEdit && (
            <button
            ...
            <div className="p-10 flex-1 flex flex-col space-y-8">
              ...
              <div className="pt-8 flex items-center justify-between border-t border-border/50 mt-auto">
                <div className="flex flex-col space-y-1">
                  <span className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground/30">Code</span>
      ...
      {rows.length === 0 && !loading && (
        <div className="py-40 text-center space-y-8 bg-card border-2 border-dashed border-border rounded-[4rem] shadow-2xl relative overflow-hidden group">
          ...
          <div className="space-y-3 relative z-10">
            <p className="text-3xl font-black text-foreground tracking-tighter">No Activities Yet</p>
            <p className="text-lg text-muted-foreground max-w-md mx-auto italic">
              No activities found for the selected filters. Add your first hands-on activity to get started.
            </p>
          </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-3xl z-[100] flex items-center justify-center p-4">
          <div className="bg-card border border-border rounded-[4rem] w-full max-w-4xl max-h-[90vh] overflow-y-auto p-10 sm:p-16 shadow-[0_50px_150px_rgba(0,0,0,0.5)] relative animate-in zoom-in-95 duration-500">
            ...
            <div className="space-y-4 mb-14">
              <h2 className="text-5xl font-black tracking-tighter text-primary">New Activity</h2>
              <p className="text-xl text-muted-foreground italic">Define a hands-on project activity for your students.</p>
            </div>

            <div className="space-y-12">
              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground ml-6">Activity Title</label>
                <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-4">
                  <label className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground ml-6">Program Track</label>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <label className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground ml-4">Difficulty (1-10)</label>
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground ml-6">What will students build? Describe the activity.</label>
                <textarea rows={6} placeholder="What will the student build? What is the impact? Describe the activity clearly..." value={createForm.classwork_prompt} onChange={(e) => setCreateForm((f) => ({ ...f, classwork_prompt: e.target.value }))} className="w-full px-10 py-8 bg-background border border-border rounded-[2.5rem] font-medium text-lg leading-relaxed focus:border-primary outline-none transition-all italic shadow-inner placeholder:text-muted-foreground/20" />
              </div>

              <div className="p-10 bg-muted/20 rounded-[3.5rem] border border-border space-y-8 shadow-inner">
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground text-center opacity-50">Advanced Options</p>
                <div className="grid grid-cols-2 gap-10">
                  <div className="space-y-4">
                    <label className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground ml-4">Activity Code</label>
                  ...
                  <div className="space-y-4">
                    <label className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground ml-4">Program ID</label>
      ...
      {editing && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-3xl z-[100] flex items-center justify-center p-4">
          <div className="bg-card border border-border rounded-[4rem] w-full max-w-3xl p-10 sm:p-16 shadow-2xl relative animate-in zoom-in-95 duration-500">
            ...
            <div className="space-y-4 mb-14">
              <h2 className="text-4xl font-black tracking-tighter">Edit Activity</h2>
              <p className="text-lg text-muted-foreground italic">Update the details for this activity.</p>
            </div>
            ...
            <div className="space-y-10 mb-14">
              ...
              <div className="grid grid-cols-2 gap-10">
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground ml-6">Difficulty (1-10)</label>
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground ml-6">Activity Description</label>
              ...
              <label className="flex items-center gap-6 p-8 bg-muted/20 border border-border rounded-[2.5rem] cursor-pointer hover:border-primary transition-all group shadow-inner">
                ...
                <div className="flex flex-col space-y-1">
                  <span className="text-xl font-black uppercase tracking-widest text-foreground group-hover:text-primary transition-colors">Status: {editing.is_active ? 'Active' : 'Archived'}</span>
                  <span className="text-sm text-muted-foreground italic">When active, this activity can be assigned in lessons.</span>
                </div>
              </label>
            </div>
