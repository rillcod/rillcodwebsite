...
function SchoolDirectionPageInner() {
  ...
  return (
    <main className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
      <Link href="/dashboard/academic/certify" className="mb-5 inline-flex items-center gap-2 text-sm font-bold text-muted-foreground hover:text-foreground"><ArrowLeftIcon className="h-4 w-4" /> Academic Office</Link>
