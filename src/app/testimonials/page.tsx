...
const testimonials = [
  ...
  },
  {
    ...
    content: "The robotics program at Rillcod Academy is amazing! I built a smart traffic light system using Python and Arduino. The teachers are so supportive and the hands-on projects make learning fun. I've learned so much about problem-solving and critical thinking.",
    rating: 5,
    category: "Student",
    image: "/api/placeholder/100/100",
  ...
  },
  {
    ...
    content: "I never thought I could code, but Rillcod Academy made it so accessible. The micro-lessons and self-paced learning allowed me to learn at my own speed. Now I'm building websites and helping other students! The portfolio feature is fantastic for showcasing my work.",
    rating: 5,
    category: "Student",
    image: "/api/placeholder/100/100",
  ...
  },
  {
    ...
    content: "My son's logical thinking has improved dramatically since joining Rillcod Academy. He's now solving complex problems and thinking systematically. The investment in his future is worth every kobo. The teachers are patient and understanding.",
    rating: 5,
    category: "Parent",
    image: "/api/placeholder/100/100",
