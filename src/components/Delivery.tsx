...
import { Calendar, Clock, Users, Monitor, Laptop, Lightbulb, School } from 'lucide-react';
    ...
    <section className="py-16 md:py-24 bg-card">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* For Schools */}
          <div className="bg-primary/5 rounded-2xl shadow-md p-8 border-t-4 border-primary">
            ...
            <ul className="space-y-4">
              <li className="flex">
                <Clock className="w-6 h-6 text-primary mr-3 flex-shrink-0" />
              ...
              <li className="flex">
                <Monitor className="w-6 h-6 text-primary mr-3 flex-shrink-0" />
                <p className="text-foreground/80">Minimum 10 functional computer systems required for school programs</p>
              </li>
              <li className="flex">
                <Lightbulb className="w-6 h-6 text-primary mr-3 flex-shrink-0" />
          ...
          <div className="bg-emerald-500/5 rounded-2xl shadow-md p-8 border-t-4 border-emerald-500">
            ...
            <div className="mt-8">
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3 bg-emerald-600 text-white text-lg font-bold rounded-full shadow-md hover:bg-emerald-700 transform transition-all duration-300 hover:scale-105"
              >
                Register Your Child
              </a>
            </div>
