    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">How We Deliver</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-blue-50 rounded-2xl shadow-md p-8 border-t-4 border-blue-500">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-800">For Schools</h3>
            </div>
            
            <ul className="space-y-4">
              <li className="flex">
                <Clock className="w-6 h-6 text-blue-500 mr-3 flex-shrink-0" />
                <p className="text-gray-700">Each session minimum 40 minutes, twice a week, integrated with school schedule</p>
              </li>
              <li className="flex">
                <Users className="w-6 h-6 text-blue-500 mr-3 flex-shrink-0" />
                <p className="text-gray-700">Project tasks done in groups to encourage collaboration and teamwork</p>
              </li>
              <li className="flex">
                <Monitor className="w-6 h-6 text-blue-500 mr-3 flex-shrink-0" />
                <p className="text-gray-700">Minimum 10 functional computer systems required for school programs</p>
              </li>
              <li className="flex">
                <Lightbulb className="w-6 h-6 text-blue-500 mr-3 flex-shrink-0" />
                <p className="text-gray-700">Partnership fee discussion (70% Academy, 30% School split)</p>
              </li>
            </ul>
          ...
          <div className="bg-green-50 rounded-2xl shadow-md p-8 border-t-4 border-green-500">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-800">For Individual Students</h3>
            </div>
            
            <ul className="space-y-4">
              <li className="flex">
                <Calendar className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" />
                <p className="text-gray-700">Flexible scheduling options, weekend and after-school classes available</p>
              </li>
              <li className="flex">
                <Users className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" />
                <p className="text-gray-700">Project tasks done in groups to build social and collaborative skills</p>
              </li>
              <li className="flex">
              ...
              <li className="flex">
                ...
                <p className="text-gray-700">Recommendation: Mini laptop or notebook for personal practice</p>
              </li>
              <li className="flex">
                <Lightbulb className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" />
                <p className="text-gray-700">Individual fee: ₦15,000 per learner (subject to review)</p>
              </li>
            </ul>
