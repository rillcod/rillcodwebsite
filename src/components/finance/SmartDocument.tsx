    ...
    <>
      ...
      <div className="print:hidden flex items-center justify-between mb-4 gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            onClick={copyRef}
            className="flex items-center gap-2 px-3 py-2 bg-muted hover:bg-slate-200 text-muted-foreground text-[10px] font-black uppercase tracking-widest transition-colors rounded-xl"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 text-[#25D366] text-[10px] font-black uppercase tracking-widest transition-colors rounded-xl"
          >
