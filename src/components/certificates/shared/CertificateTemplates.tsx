...
export function CertificateTemplates({
    ...
    return (
        <div className="w-full h-full relative overflow-hidden bg-card select-none">
                ...
                <div className="absolute inset-0 flex" style={{ background: 'linear-gradient(135deg, #050300 0%, #150a00 50%, #050300 100%)' }}>
                    ...
                    <div className="flex flex-col items-center justify-between py-[4%] px-[2.5%]" style={{ width: '25%', borderRight: '1px solid rgba(249,115,22,0.2)' }}>
                        <div className="flex flex-col items-center gap-3">
                            <div className="w-20 h-20 flex items-center justify-center rounded-2xl bg-primary/10 border border-primary/30 shadow-lg shadow-primary/5">
                                <img src="/images/logo.png" alt="Rillcod" className="w-[85%] h-auto object-contain brightness-110" 
                                    onError={e => (e.currentTarget.style.display = 'none')} />
                            </div>
                            <p className="text-[10px] text-primary font-black uppercase tracking-[0.3em] text-center leading-tight">
                                Rillcod <br/> Academy
                            </p>
                ...
                <div className="absolute inset-0 p-8 border-[12px] border-double border-[#C5A059]" style={{ backgroundColor: '#FFFEF7' }}>
                    ...
                    <div className="h-full flex flex-col items-center justify-between text-center relative z-10 py-6">
                        ...
                        <div className="space-y-1">
                            ...
                            <h2 className="text-[52px] font-serif text-primary tracking-tight leading-none mb-4 italic font-bold" style={{ textShadow: '1px 1px 1px rgba(0,0,0,0.1)' }}>
                                {studentName}
                            </h2>
                            <p className="text-[14px] text-[#4A4A4A] font-serif italic max-w-2xl mx-auto border-t border-b border-primary/20 py-4">
                        ...
                        <div className="flex w-full items-end justify-between px-12">
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="w-14 h-14 rounded-full border-4 border-primary/40 flex items-center justify-center bg-white/50 backdrop-blur-sm">
            ...
            {/* ════ CYBER TECH ═════════════════════════════════════════════ */}
            {template === 'tech' && (
                <div className="absolute inset-0 bg-[#070400] p-6 font-mono text-primary overflow-hidden">
                    {/* Grid Background */}
                    ...
                    <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-tr from-transparent via-primary/5 to-transparent rotate-12 -translate-y-1/2" />
                    ...
                    <div className="h-full border-r-[40px] border-primary/70/40 relative z-10 flex flex-col justify-between py-10 px-12">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-[16px] text-primary max-w-xl border-l-4 border-primary pl-4 py-2 bg-primary/5">
                ...
                <div className="absolute inset-0 bg-[#FFFBF7] p-10">
                    <div className="h-full border-[1px] border-orange-200/30 flex flex-col items-center justify-between py-12 px-16 bg-card shadow-inner relative overflow-hidden">
                        ...
                        <div className="text-center space-y-6 relative z-10">
                            ...
                            <h1 className="text-[48px] font-black text-[#111827] tracking-tight leading-none px-12 border-b-[8px] border-primary inline-block pb-1">
                                {studentName}
                            </h1>
                            <p className="text-[14px] text-muted-foreground max-w-xl mx-auto leading-relaxed mt-6 font-medium">
                                ...
                                <span className="text-primary font-black text-[22px] uppercase mt-2 block tracking-tight">{courseTitle}</span>
                                <span className="text-primary font-bold text-[12px] uppercase tracking-widest mt-1 block tracking-widest opacity-80">{programName}</span>
                            </p>
                        </div>
            ...
            {template === 'spark' && (
                <div className="absolute inset-0 bg-card" style={{ background: 'linear-gradient(135deg, #F97316 0%, #D97706 50%, #92400E 100%)' }}>
                    <div className="absolute inset-4 sm:inset-6 bg-white/95 backdrop-blur-3xl rounded-3xl overflow-hidden flex flex-col items-center justify-between p-8 sm:p-12 shadow-[0_30px_60px_rgba(0,0,0,0.3)] border border-white/50">
                        ...
                        <div className="absolute -top-24 -left-24 w-64 h-64 bg-primary rounded-full blur-[80px] opacity-40 mix-blend-multiply" />
