        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="text-[11px] sm:text-xs text-muted-foreground mb-10 max-w-md">
              Online from <span className="font-bold text-foreground">{cta.onlineFeeLabel}</span>
              {' · '}Secure with <span className="font-bold text-amber-500">{cta.depositLabel}</span> deposit
              {cta.deadlineLabel ? (
