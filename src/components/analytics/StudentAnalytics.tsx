          ...
          <table className="min-w-full divide-y divide-border">
            <thead className="bg-background">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Average Score</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Completion Rate</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Student Count</th>
            ...
            <tbody className="bg-card divide-y divide-border">
              {[
                ...
                <tr key={index} className="hover:bg-background transition-all">
                  <td className="px-6 py-4 whitespace-nowrap font-medium text-foreground">{row.subject}</td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-foreground">{row.students}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
