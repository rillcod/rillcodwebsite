...
export default function BillingStickyNotices() {
  ...
  return (
    <div className="space-y-3">
      {loading ? (
        <div className="border border-border/80 bg-card/90 backdrop-blur-2xl p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xl flex items-center gap-3">
        ...
        <div key={notice.id} className="border border-amber-500/30 bg-amber-500/10 backdrop-blur-xl p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
              {!isNativeApp && (
                <Link
                  href={paymentHref}
                  className="inline-flex min-h-11 items-center gap-1.5 px-3.5 py-2 text-[10px] font-black uppercase tracking-wider border border-amber-500/30 text-amber-800 dark:text-amber-200 hover:bg-amber-500/10 rounded-xl transition-colors active:scale-95"
                >
              ...
              <Link
                ...
                className="inline-flex min-h-11 items-center gap-1.5 px-3.5 py-2 text-[10px] font-black uppercase tracking-wider border border-border text-muted-foreground hover:text-foreground hover:bg-card rounded-xl transition-colors active:scale-95"
              >
              ...
              {isAdmin && (
                <button
                  ...
                  className="inline-flex min-h-11 items-center px-3.5 py-2 text-[10px] font-black uppercase tracking-wider border border-emerald-500/30 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-500/10 rounded-xl disabled:opacity-50 transition-colors active:scale-95"
                >
