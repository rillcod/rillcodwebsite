...
export function ParentForm({
  ...
  if (credentials) {
    return (
      <div className="max-w-md mx-auto bg-card border border-border shadow-2xl overflow-hidden">
  ...
  return (
    <div className="max-w-2xl mx-auto bg-card border border-border shadow-2xl">
      <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-card">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            {schoolChanging && <p className="text-[10px] text-orange-400 mt-1 animate-pulse">Loading students for this school…</p>}
          </div>
        ...
        <div>
          ...
          {!selectedClass && <p className="text-[9px] text-orange-400/80 mt-1 font-bold uppercase tracking-tighter">Please select a class first.</p>}
        </div>
