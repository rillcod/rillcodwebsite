...
export default function VisualizationControls({
  ...
  return (
    <div className={cn(
      ...
      <div className="relative w-full h-1 bg-zinc-800 hover:h-2 transition-all group/timeline cursor-pointer overflow-hidden rounded-xl">
        <motion.div 
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
        {/* Core Control Group */}
        <div className="flex items-center gap-1.5 p-1 bg-black/40 border border-white/5 rounded-xl shadow-inner">
          <Button 
            variant="ghost" 
            size="icon" 
            onClick={onRestart}
            className="w-9 h-9 text-muted-foreground/70 hover:text-white hover:bg-white/5 transition-all rounded-xl"
          >
          ...
          <Button 
            ...
            className="w-9 h-9 text-muted-foreground/70 hover:text-white hover:bg-white/5 transition-all rounded-xl disabled:opacity-20"
          >
