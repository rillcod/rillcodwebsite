    ...
    switch (profile.role) {
      ...
      case 'admin':
        return filterEntries([
          ...
          { name: 'Academic Office', href: '/dashboard/academic-spine', icon: ShieldCheckIcon },
          { name: 'Academic Office Guide', href: '/dashboard/academic-spine/guide', icon: DocumentTextIcon },
          ...
          { divider: true, label: 'Learning Insights' },
          { name: 'Learner Progression', href: '/dashboard/progression', icon: RocketLaunchIcon },
          { name: 'Projects & Activities', href: '/dashboard/progression/project-registry', icon: SparklesIcon },
          { name: 'Learner Progress Insights', href: '/dashboard/progression/analytics', icon: ChartBarIcon },
          { name: 'Academic Change History', href: '/dashboard/progression/audit', icon: ClipboardDocumentListIcon },

          { divider: true, label: 'Safety & Support' },
          { name: 'Safety Centre', href: '/dashboard/progression/communication-safety', icon: ShieldCheckIcon },
          { name: 'Safety Cases', href: '/dashboard/progression/communication-reports', icon: ChatBubbleLeftRightIcon },
          ...
          { name: 'System Health', href: '/dashboard/progression/marker-integrity', icon: ClipboardDocumentCheckIcon },
      ...
      case 'teacher':
        return filterEntries([
          ...
          { name: 'Academic Office', href: '/dashboard/academic-spine', icon: ShieldCheckIcon },
          { name: 'Academic Office Guide', href: '/dashboard/academic-spine/guide', icon: DocumentTextIcon },
          { name: 'Teaching Plans', href: '/dashboard/lesson-plans', icon: ClipboardDocumentListIcon },
          { name: 'Curriculum Guide', href: '/dashboard/curriculum', icon: BookOpenIcon },
          { name: 'Learning Resources', href: '/dashboard/library', icon: ArchiveBoxIcon },
      ...
      case 'school':
        return [
          ...
          { name: 'Academic Office Guide', href: '/dashboard/academic-spine/guide', icon: DocumentTextIcon },
          { name: 'Curriculum Coverage', href: '/dashboard/curriculum/progress', icon: PresentationChartLineIcon },
