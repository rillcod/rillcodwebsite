...
const PAGE_ITEMS_BY_ROLE: Record<string, PageItem[]> = {
  ...
  teacher: [
    ...
    { name: 'Class progress', href: '/dashboard/learner-progress?view=delivery', icon: ChartBarIcon, keywords: 'coverage taught mark' },
    { name: 'Students', href: '/dashboard/students', icon: UserGroupIcon },
    { name: 'Mark work', href: '/dashboard/grades', icon: TrophyIcon, keywords: 'grading gradebook' },
    { name: 'Results', href: '/dashboard/academic/results', icon: TrophyIcon, keywords: 'report cards auto-fill' },
