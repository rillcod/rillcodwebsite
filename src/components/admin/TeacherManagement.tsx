...
export default function TeacherManagement() {
  ...
  return (
    <div className="space-y-8 p-4 font-sans">
      ...
      {/* Filters */}
      <div className="bg-card border-4 border-black p-4 shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
      ...
      {/* Teachers Table */}
      <div className="bg-card border-4 border-black shadow-[8px_8px_0_0_rgba(0,0,0,1)] overflow-x-auto">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y-4 divide-black">
            ...
            <tbody className="bg-card divide-y-2 divide-black">
              {filteredTeachers.map((teacher) => (
                <tr key={teacher.id} className="hover:bg-[#e1f5fe] transition-colors bg-card">
                  <td className="px-6 py-4 whitespace-nowrap border-r-2 border-black">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-sm font-bold text-foreground/80">{teacher.education}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap border-r-2 border-black">
                    <div className="text-sm font-bold text-black">{teacher.email}</div>
                    <div className="text-sm font-bold text-foreground/80 mt-1">{teacher.phone}</div>
                  </td>
                  <td className="px-6 py-4 border-r-2 border-black">
                    <div className="flex flex-wrap gap-1">
                      ...
                      {(teacher.subjects || []).length > 2 && (
                        <span className="inline-flex items-center px-3 py-1 border-2 border-black text-xs font-bold bg-card text-black shadow-[2px_2px_0_0_rgba(0,0,0,1)]">
      ...
      {showAddForm && (
        <div className="fixed inset-0 bg-background bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-card border-4 border-black p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-[12px_12px_0_0_rgba(0,0,0,1)]">
            ...
            <form onSubmit={handleAddTeacher} className="space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-4">
                <button
                  ...
                  className="px-6 py-2 border-2 border-black font-bold text-black bg-card hover:-translate-y-1 hover:shadow-[4px_4px_0_0_rgba(0,0,0,1)] transition-all"
                >
                  Cancel
                </button>
                <button
      ...
      {showDetails && selectedTeacher && (
        <div className="fixed inset-0 bg-background bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-card border-4 border-black p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-[12px_12px_0_0_rgba(0,0,0,1)]">
