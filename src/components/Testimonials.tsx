    ...
    <section className="py-24 bg-[#121212] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-24">
          ...
          <p className="text-lg text-muted-foreground/70 max-w-2xl mx-auto font-medium italic border-l-2 border-primary pl-8 inline-block text-left">
        ...
        <div className="max-w-5xl mx-auto bg-[#1a1a1a] border border-border rounded-none shadow-2xl p-12 mb-24 relative border-t-8 border-t-purple-500">
          ...
          <p className="text-2xl md:text-3xl font-black text-white text-center italic mb-10 tracking-tight leading-snug uppercase">
            "Rillcod projects are engineered for <span className="text-purple-500">precision</span> and <span className="text-primary">excellence</span>, transforming how students perceive systemic problem solving."
          </p>
          
          <div className="flex items-center justify-center">
            <div className="w-16 h-16 bg-white/5 border border-border rounded-none flex items-center justify-center text-primary mr-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {schools.map((school, index) => (
            <div 
              key={index}
              className="bg-[#1a1a1a] border border-border rounded-none p-10 flex flex-col items-center hover:border-primary transition-all group"
            >
