...
export default function StudyAssistant({
  ...
  lessonObjectives, externalMessage, isOpen, onClose,
}: StudyAssistantProps) {
  ...
  }, [isOpen, hasOpened, lessonTitle, courseTitle]);
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-[calc(var(--app-bottom-nav-height)+var(--app-sticky-actions-height))] right-0 sm:bottom-6 sm:right-6 z-50 w-full sm:w-[360px] bg-card border border-border sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden"
          style={{ height: 'min(500px, calc(80dvh - var(--app-bottom-nav-height) - var(--app-sticky-actions-height) - 2rem))' }}
        >
          {/* Header */}
          <div className="flex items-center gap-3 px-4 py-3 border-b border-border bg-card shrink-0">
            ...
            {/* Single X close button on all screen sizes */}
