...
export default function NeuralVoiceReader({ content, title, isOpen, onClose }: NeuralVoiceReaderProps) {
  ...
  return (
    <div className="fixed bottom-[calc(var(--app-bottom-nav-height)+var(--app-sticky-actions-height))] left-0 right-0 sm:bottom-6 sm:left-6 sm:right-auto sm:w-[300px] z-50">
