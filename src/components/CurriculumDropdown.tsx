                  ...
                  {module.topics && (
                    <div className="bg-background rounded-lg p-4">
                      <h5 className="font-semibold text-foreground mb-3 flex items-center">
                        <LightBulbIcon className="w-5 h-5 text-yellow-600 dark:text-yellow-400 mr-2" />
                        Key Topics Covered:
                      </h5>
                      <ul className="space-y-2">
                        {module.topics.map((topic: string, topicIndex: number) => (
                          <li key={topicIndex} className="flex items-start">
                            <CheckCircleIcon className="w-4 h-4 text-green-600 dark:text-green-400 mr-3 mt-1 flex-shrink-0" />
