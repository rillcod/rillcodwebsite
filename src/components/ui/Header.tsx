      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center gap-4 group">
            <div className="w-14 h-14 bg-primary flex items-center justify-center rounded-xl shadow-xl shadow-primary/20 group-hover:scale-110 transition-transform duration-300">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <div className="relative">
              <button
                ...
                className="bg-primary text-primary-foreground px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-[0.3em] hover:bg-primary/90 transition-all flex items-center gap-3 shadow-xl shadow-primary/20"
              >
              ...
              {activeDropdown === 'portals' && (
                <div className="absolute top-full right-0 mt-4 w-64 bg-card border border-border rounded-xl shadow-2xl py-3 z-50">
