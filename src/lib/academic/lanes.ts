...
export const LANES: Record<LaneId, { id: LaneId; label: string; scope: string; summary: string }> = {
  asset: {
    ...
    label: "Curriculum",
    scope: "course",
    summary: "Write each course once, approve it, then assign it where it is taught.",
  },
  delivery: {
    id: "delivery",
    label: "Teaching",
    scope: "class",
    summary: "Open one class to plan, teach, assess and prepare its results.",
  },
};
...
export const STAGES: Stage[] = [
  // ── Lane A — the curriculum asset (course-scoped) ────────────────────────
  {
    ...
    step: 1,
    label: "Write",
    purpose: "Write the course curriculum: terms, weeks and topics.",
  ...
  },
  {
    ...
    step: 2,
    label: "Approve",
    purpose: "Review the curriculum, then make it the approved version.",
  ...
  },
  {
    ...
    label: "Assign",
    purpose:
      "Assign the approved curriculum to schools, online classes and special programmes.",
  ...
  },
  {
    ...
    step: 4,
    label: "Start point",
    purpose: "Set the term and week where each school or class starts.",
  ...
  // ── Lane B — delivery to a class (class-scoped) ──────────────────────────
  {
    ...
    step: 1,
    label: "Class plan",
    purpose: "Open the class plan built from its assigned curriculum.",
  ...
  },
  {
    ...
    step: 2,
    label: "Teach",
    purpose: "Run lessons, slides and practice, take attendance and adapt teaching for this class.",
    href: "/dashboard/classes",
    actors: ["admin", "teacher"],
    observers: ["school"],
  ...
  },
  {
    ...
    step: 3,
    label: "Progress",
    purpose: "Record what was taught, missed or moved to another week.",
  ...
  },
  {
    ...
    step: 4,
    label: "Mark work",
    purpose: "Review assignments, tests, projects and practical work in one grading flow.",
  ...
  },
  {
    ...
    step: 5,
    label: "Results",
    purpose: "Optionally bring in class work, confirm scores, then publish.",
...
export const LANE_NAVIGATION: Record<LaneId, LaneNavigationStep[]> = {
  asset: [
    {
      ...
      lane: "asset",
      step: 1,
      label: "Write curriculum",
      purpose: "Choose a course and write or continue its weeks.",
      href: "/dashboard/academic/build",
      stageIds: ["author"],
    },
    {
      ...
      purpose: "Review once, approve it, assign it, and set any different start points.",
  ...
  delivery: [
    ...
    // navigation step, because there is one place to go.
    {
      ...
      lane: "delivery",
      step: 1,
      label: "Open class plan",
      purpose:
        "Open one class to prepare every learning item, teach the week and record progress.",
      href: "/dashboard/classes",
    ...
    },
    {
      ...
      purpose: "Review marked work, optionally fill scores, then publish the result.",
      href: "/dashboard/academic/results",
