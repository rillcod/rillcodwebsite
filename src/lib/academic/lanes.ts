...
export const STAGES: Stage[] = [
  ...
  },
  {
    ...
    href: "/dashboard/academic-direction",
    actors: ["admin"],
    observers: [],
  ...
  },
  {
    ...
    href: "/dashboard/curriculum/studio/schools",
    actors: ["admin"],
    observers: [],
  ...
  },
  {
    ...
    step: 2,
    label: "Teach",
    purpose: "Run lessons, take attendance and adapt delivery for this class.",
    href: "/dashboard/classes",
    actors: ["admin", "teacher"],
    observers: ["school"],
  ...
  },
  {
    ...
    step: 4,
    label: "Evidence",
    purpose: "Collect assignments, tests and practical work as real evidence.",
