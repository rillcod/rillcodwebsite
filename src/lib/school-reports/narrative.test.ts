...
describe('school report fallback narrative', () => {
  it('uses only supplied aggregate values', () => {
    const snapshot = {
      ...
      generatedAt: '', scoreBands: [], attendanceBands: [], classPerformance: [], learners: [], programmeCoursePerformance: [], finance: { currency: 'NGN', invoiceCount: 0, totalInvoiced: 0, totalPaid: 0, totalOutstanding: 0, attached: false, requestMessage: null, billingHref: '/dashboard/school-billing', invoices: [] }, completeness: { readyToPublish: false, score: 0, totalRequired: 1, completedRequired: 0, items: [] }, dataNotes: [],
